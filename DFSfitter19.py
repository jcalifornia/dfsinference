...
class DFSfitter(object):
    ...
    def solveSemiclassically(self,params,err=False):
        ...
        optimout = scipy.optimize.root(self.residual,np.zeros(self.bins*2),(Rf,Rg,Rgz))
        #if optimout.success==False:
        #    optimout = scipy.optimize.root(self.residual,np.zeros(self.bins*2),(Rf,Rg,Rgz),method="lm")
